    ...
    if not uploaded_file or not product_desc:
        ...
        with st.spinner("正在魔法处理中，请稍候..."):
            ...
            try:
                ...
                titles = title_res['choices'][0]['message']['content']
            except:
            ...
            with col2:
                # 提示：因为换脸需要蒙版，实际使用时AI会根据算法自动抠出衣服，这里做效果预览
                st.image(uploaded_file, caption="生成效果图（模特脸部已本地化/背景已更换）", use_container_width=True)
